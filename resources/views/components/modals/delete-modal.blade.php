<div class="delete-modal auth-modal modal">
    <div class="delete-modal__container modal__container">
        <button class="delete-modal__close modal__close">
        ...
        <div class="delete-modal__content modal__content">
            <div class="delete-modal__header modal__header">
                ...
                <p class="delete-modal__subtitle modal__subtitle">Вы точно хотите произвести удаление данной {{ $name }}?</p>
            </div>
            <div class="delete-modal__row">
                <button class="modal__close delete-modal__button delete-modal__no modal__button">Нет</button>
                <button class="delete-modal__button delete-modal__yes modal__button" id="delete">Да</button>
            </div>
        </div>
    </div>
</div>