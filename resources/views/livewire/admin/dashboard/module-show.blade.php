<div class="modules-table__container">
    <div class="admin-panel-info-new-users__header">
        <h3 class="admin-panel-info-new-users__title">Модули</h3>
        <form wire:submit.prevent="searchModules()" class="admin-panel-info-new-users__form">
        ...
        <div class="admin-panel-info-new-users__buttons">
            <a href="{{ route('modules.add') }}" class="admin-panel-info-groups__button">Добавить модуль</a>
        </div>
    </div>
    <div class="users-table modules-table">
        <div class="admin-panel-info-new-users__table new-users-table">
            <div class="new-users-table__item new-users-table__header">
                ...
                <p class="new-users-table__name course__id">id курса</p>
                <p class="new-users-table__name groups__id">id группы</p>
                <p class="new-users-table__name course__name">Название курса</p>
                <p class="new-users-table__name group__name">Название группы</p>
                <p class="new-users-table__name module__number">Номер модуля</p>
                <p class="new-users-table__name date">Дата изменения</p>
                <p class="new-users-table__name date">Дата добавления</p>
                <p class="new-users-table__name admin-control__buttons modules-buttons admin-control__hide">
            ...
            <div class="row__items">
                ...
                <div class="new-users-table__item" wire:key="{{ $module->id }}">
                    <p class="new-users-table__name id">{{ $module['id'] }}</p>
                    <p class="new-users-table__name course__id">{{ $module['course_id'] }}</p>
                    <p class="new-users-table__name groups__id">{{ $module['group_id'] }}</p>
                    <p class="new-users-table__name course__name">{{ $module->course['name'] }}</p>
                    <p class="new-users-table__name group__name">{{ $module->group['name'] }}</p>
                    <p class="new-users-table__name module__number">{{ $module['module_number'] }}</p>
                    <p class="new-users-table__name date">{{ $module['created_at'] }}</p>
                    <p class="new-users-table__name date">{{ $module['updated_at'] }}</p>
                    <p class="new-users-table__name admin-control__buttons modules-buttons">
                        <a href="{{ route('modules.more', $module['id']) }}">
                            <svg width="23" height="5" viewBox="0 0 23 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button wire:click="destroy( {{ $module['id'] }} )">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.5 5.625H22.5M8.75 1.875H16.25M10 18.125V10.625M15 18.125V10.625M16.875 23.125H8.125C6.74429 23.125 5.625 22.0057 5.625 20.625L5.05425 6.92704C5.02466 6.21688 5.59239 5.625 6.30317 5.625H18.6968C19.4076 5.625 19.9753 6.21688 19.9457 6.92704L19.375 20.625C19.375 22.0057 18.2557 23.125 16.875 23.125Z" stroke="#6C63FF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
