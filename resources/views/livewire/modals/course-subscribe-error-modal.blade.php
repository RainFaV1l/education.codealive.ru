<div class="auth-modal modal course-subscribe-error-modal">
    <div class="auth-modal__container modal__container">
        <button class="auth-modal__close modal__close">
        ...
        <div class="auth-modal__content modal__content">
            <div class="auth-modal__header modal__header">
                <h2 class="auth-modal__title modal__title">Заявка отправлена</h2>
                <p class="auth-modal__subtitle modal__subtitle">Вы уже отправили заявку, подождите пока ее обработает администратор</p>
            </div>
            <a href="{{ route('applications.index') }}" class="auth-modal__button modal__button">Смотреть заявки</a>
        </div>
    </div>
</div>
