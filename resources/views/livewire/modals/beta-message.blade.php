...
<div class="beta-message">
    <div class="beta-message__container container">
        <div class="beta-message__close">
        ...
        <p class="beta-message__message">
            Система находится в разработке.
            Нашли ошибку, есть пожелания?
        </p>
        <p class="beta-message__message">Пожалуйста, опишите проблему, пожелания <a target="_blank" href="https://forms.gle/nKnB6GVWGKTTfBzCA">в данной форме</a>.</p>
    </div>
</div>